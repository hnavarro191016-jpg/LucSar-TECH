  ...
  return (
    <section id="contacto" className={`section ${styles.ctaSection}`}>
      <div className={`container ${styles.ctaContainer}`}>
        ...
        <a href="https://wa.me/528115187738?text=Hola%20LuSam%20TECH,%20quiero%20empezar%20mi%20transformaci%C3%B3n%20digital" target="_blank" rel="noopener noreferrer" className={`btn btn-primary ${styles.ctaBtn}`}>
